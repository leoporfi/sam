#!/usr/bin/env python3
"""
Script para aplicar el Stored Procedure de Análisis de Patrones Temporales.
"""
...
def main():
    ...
    SERVICE_NAME = "apply_sp_patrones"
    ConfigLoader.initialize_service(SERVICE_NAME)
    setup_logging(service_name=SERVICE_NAME)

    print("=" * 60)
    print("APLICANDO SP: AnalisisPatronesTemporales")
    print("=" * 60)
    ...
    # Leer archivo SQL
    sql_path = Path(__file__).resolve().parent.parent / "database" / "procedures" / "dbo_AnalisisPatronesTemporales.sql"
