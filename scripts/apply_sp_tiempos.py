#!/usr/bin/env python3
"""
Script para aplicar el Stored Procedure mejorado de Tiempos de Ejecución.
"""
...
def main():
    ...
    SERVICE_NAME = "apply_sp_tiempos"
    ConfigLoader.initialize_service(SERVICE_NAME)
    setup_logging(service_name=SERVICE_NAME)

    print("=" * 60)
    print("APLICANDO SP: AnalisisTiemposEjecucionRobots (MEJORADO)")
    print("=" * 60)
    ...
    sql_path = (
        ...
        / "database"
        / "procedures"
        / "dbo_AnalisisTiemposEjecucionRobots_MEJORADO.sql"
    )
    ...
    try:
        ...
        # Separar por GO si es necesario, pero pyodbc a veces no soporta GO
        # En este caso, el archivo parece tener un solo bloque grande CREATE/ALTER
        # Vamos a intentar ejecutarlo eliminando los GO
