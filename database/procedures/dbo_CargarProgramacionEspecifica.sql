...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CargarProgramacionEspecifica]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[CargarProgramacionEspecifica] AS'
END
-- =============================================
-- Author:      <Author,,Name>
...
-- =============================================
ALTER PROCEDURE [dbo].[CargarProgramacionEspecifica]
    @Robot NVARCHAR(100),
