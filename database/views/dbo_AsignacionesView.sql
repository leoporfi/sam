...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[AsignacionesView]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.AsignacionesView
AS
...
IF NOT EXISTS (SELECT * FROM sys.fn_listextendedproperty(N'MS_DiagramPaneCount' , N'SCHEMA',N'dbo', N'VIEW',N'AsignacionesView', NULL,NULL))
